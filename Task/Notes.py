...
# Pydantic schema for note creation/updation
...
# Get a specific note
@router.get("/note/{id}/", status_code=status.HTTP_200_OK)
...
@router.put("/note/{id}/", status_code=status.HTTP_200_OK)
...
# Delete a note
@router.delete("/note/{id}/", status_code=status.HTTP_200_OK)
